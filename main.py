...
class Game:
    def __init__(self):
        ...
        self.score = 0
        self.font = pygame.font.Font('KdamThmorPro-Regular.ttf', 20)
        ...
        # Audio
        music = pygame.mixer.Sound('mixkit-short-laser-gun-shot-1670.wav')
        ...
        for row_index, row in enumerate(self.shape):
            for col_index, col in enumerate(row):
                if col == '*':
                    ...
                    block = obstacle.Block(self.block_size, (240, 73, 73), x, y)
